...
export const blogQueries = {
  ...
  getPostBySlug: (slug) => ` // eslint-disable-line @typescript-eslint/no-unused-vars
  ...
  getPostsByCategory: (category) => ` // eslint-disable-line @typescript-eslint/no-unused-vars
  ...
  getRelatedPosts: (currentPostId, category, tags) => ` // eslint-disable-line @typescript-eslint/no-unused-vars
